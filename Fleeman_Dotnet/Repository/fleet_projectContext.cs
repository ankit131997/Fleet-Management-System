...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=fleet_project;user=root;password=root", ServerVersion.Parse("8.0.37-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<airport_master>(entity =>
        {
            ...
            entity.HasOne(d => d.city).WithMany(p => p.airport_masters).HasConstraintName("FKnacm5228qoxi0egygij94kqje");

            entity.HasOne(d => d.hub).WithMany(p => p.airport_masters).HasConstraintName("FK9q13ys5sara44e3t8iwsbehe7");

            entity.HasOne(d => d.state).WithMany(p => p.airport_masters).HasConstraintName("FKgykh73g2t7b9tyhou2eve5ljf");
        });
        ...
        modelBuilder.Entity<booking_detail_table>(entity =>
        {
            ...
            entity.HasOne(d => d.addon).WithMany(p => p.booking_detail_tables).HasConstraintName("FKl1eiva9sie32vxofv6l7qj0g8");

            entity.HasOne(d => d.booking).WithMany(p => p.booking_detail_tables).HasConstraintName("FK8lhwsgs4ew5tdogoed7fpif4a");
        });
        ...
        modelBuilder.Entity<booking_header_table>(entity =>
        {
            ...
            entity.HasOne(d => d.car).WithMany(p => p.booking_header_tables).HasConstraintName("FKmmkg1viclerruhttx06973w3j");

            entity.HasOne(d => d.cartype).WithMany(p => p.booking_header_tables).HasConstraintName("FKopo340pd5jigmo84cahh57cwo");

            entity.HasOne(d => d.cust).WithMany(p => p.booking_header_tables)
        ...
        modelBuilder.Entity<car_master>(entity =>
        {
            ...
            entity.HasOne(d => d.cartype).WithMany(p => p.car_masters).HasConstraintName("FKe7t3ybbd5mnrqomrch1wuyc6m");

            entity.HasOne(d => d.hub).WithMany(p => p.car_masters).HasConstraintName("FKrbd83493vx6lu3vprvkx8qgqh");
        });
        ...
        modelBuilder.Entity<city_master>(entity =>
        {
            ...
            entity.HasOne(d => d.state).WithMany(p => p.city_masters).HasConstraintName("FKfxtjuwt9iqx9n7xl6f8wl6uu4");
        });
        ...
        modelBuilder.Entity<hub_master>(entity =>
        {
            ...
            entity.HasOne(d => d.city).WithMany(p => p.hub_masters).HasConstraintName("FK7rdbu34jsqwuoyuound4e830p");

            entity.HasOne(d => d.state).WithMany(p => p.hub_masters).HasConstraintName("FKf94kvk79lamurkcyvj8hhop1q");
        });
        ...
        modelBuilder.Entity<invoice_detail_table>(entity =>
        {
            ...
            entity.HasOne(d => d.addon).WithMany(p => p.invoice_detail_tables).HasConstraintName("FKdxr8d4h98iq24g5944vho0txs");

            entity.HasOne(d => d.invoice).WithMany(p => p.invoice_detail_tables).HasConstraintName("FKjij1hnrk7hmdm8oq5yguqo8o9");
        });
        ...
        modelBuilder.Entity<invoice_header_table>(entity =>
        {
            ...
            entity.HasOne(d => d.booking).WithMany(p => p.invoice_header_tables).HasConstraintName("FK5dvc2a779phnc8cjjxx94swb5");

            entity.HasOne(d => d.car).WithMany(p => p.invoice_header_tables).HasConstraintName("FKt256nitu82j1d1ryxv2h7mx4r");

            entity.HasOne(d => d.cust).WithMany(p => p.invoice_header_tables).HasConstraintName("FKskcvkb6nr6713a2rjgy027a97");
        });
